...
ram = st.radio('RAM(in GB)', [2,4,8,12,16,24,32,64,128], index =2, horizontal= True)
...
screen_res = st.selectbox("Screen Resolution", ["1366x768", "1440x900", "1600x900", "1920x1080","1920x1200","2160x1440", 
                                                "2256x1504","2304x1440","2400x1600","2560x1440","2560x1600","2736x1824","2880x1800","3200x1800","3840x2160"], index = 3)
if st.button("PREDICT PRICE"):
    ...
    op = pipe.predict(query)   # op is output
    f_op = int(round(op[0], -2)) #formated output f_op
